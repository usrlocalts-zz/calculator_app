...
var append_history_element = function(state) {
    var elem = "<h4>Operation: " + $("#command").val() + " Value: " + (state == null ? "Undefined Operation" : state);
    $("#calculator_history").append(elem);
}
var check_submit = function() {
    ...
    $.ajax({
        ...
        success: function(data) {
            append_history_element(data.state);
        }
    })
}
